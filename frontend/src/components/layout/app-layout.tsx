    ...
    <div className="flex h-screen bg-background">
      ...
      >
        ...
        <div className="p-4 border-b border-sidebar-border flex items-center justify-between">
          ...
          >
            <img src={APP_CONFIG.logo} alt={APP_CONFIG.name} className="w-6 h-6 object-contain" />
            <span className="text-xl font-bold text-sidebar-foreground">{APP_CONFIG.name}</span>
          </motion.div>
          <button
