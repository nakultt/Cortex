  ...
  return (
    ...
    >
      {isUser ? (
        ...
        <div className="max-w-[70%] bg-secondary text-secondary-foreground px-4 py-3 rounded-4xl rounded-br-lg shadow-sm">
...
const ChatInterface = ({ conversationId: initialConversationId }: ChatInterfaceProps) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Capture conversation_id from response for future messages
